...
// encontrando a palavra ou número em uma posição específica da array e criando uma array apenas com elas, em ordem:
let calibrationFindNumber = [];

for (let i = 0; i < 1000; i++) {
  let nova = calibrationArray[i].match(
    /(one|two|three|four|five|six|seven|eight|nine|[1-9])/gi
  );
